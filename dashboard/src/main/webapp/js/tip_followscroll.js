...
if(typeof tt_config == "undefined")
	alert("Error:\nThe core tooltip script file 'wz_tooltip.js' must be included first, before the plugin files!");

// Here we define new global configuration variable(s) (as members of the
// predefined "tt_config." class).
// From each of these tt_config variables, wz_tooltip.js will automatically derive
// a command which can be passed to Tip() or TagToTip() in order to customize
// tooltips individually. These command names are just the tt_config variable
// name(s) translated to uppercase,
// e.g. from tt_config. FollowScroll a command FOLLOWSCROLL will automatically be
// created.

//===================	GLOBAL TOOLTIP CONFIGURATION	======================//
tt_config. FollowScroll = false		// true or false - set to true if you want this to be the default behaviour
