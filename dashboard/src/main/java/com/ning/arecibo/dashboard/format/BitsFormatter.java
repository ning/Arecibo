...
public class BitsFormatter extends NumberFormat {
	...
	protected static final NumberFormat[] numberFormatBitsOctetsInstances = {
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,1),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,2),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,3),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,4),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,5),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,6),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,7),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,8),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,9),
		new BitsFormatter(FORMAT_TYPE_BITS_OCTETS,10)};
	
	protected final static TickUnits standardTickUnitsBitsOctets = createStandardTickUnits(numberFormatBitsOctetsInstances);
	
	public BitsFormatter(String formatSpecifier,int numDecimals) {
