...
public class TestTimelineEventHandler
{
    ...
    public void testDownsizingValues() throws Exception
    {
        ...
        final int hostId = 1;
        final TimelineEventHandler handler = new TimelineEventHandler(config, dao, timelineCoder, sampleCoder, new BackgroundDBChunkWriter(dao, config, true), new MockFileBackedBuffer());
