...
public class TestSampleCoder
{
    ...
    public void testScan() throws Exception
    {
        ...
        final TimelineTimes times = new TimelineTimes(-1, -1, startTime, endTime,
    ...
    public void testTimeRangeSampleProcessor() throws Exception
    {
        ...
        final TimelineTimes times = new TimelineTimes(0, -1, startTime, endTime, ImmutableList.<DateTime>of(startTime, endTime));
