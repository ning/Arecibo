...
describe('The graph builder', function () {
    it('shoud be able to create the controls renderer fields', function() {
    ...
    it('shoud be able to create the controls offset fields', function() {
    ...
    it('shoud be able to create the controls interpolation fields', function() {
